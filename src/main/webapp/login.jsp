...
<div class="card">
    ...
    <form action="login" method="post">
        ...
        <div class="field">
            ...
            <div class="pw-wrap">
                <input type="password" name="password" id="pwInput" placeholder="Enter your password" required autocomplete="current-password">
                <button type="button" class="pw-eye" onclick="togglePw()" id="pwEye">👁️</button>
            </div>
        </div>
        <button type="submit" class="btn-submit">Sign In</button>
        <div style="text-align:center;margin-top:12px;">
            <a href="forgot_password.jsp" style="font-size:12.5px;color:var(--muted);text-decoration:none;transition:color .18s;"
